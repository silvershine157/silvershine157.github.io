---
layout: ie
title: Cart-Pole Feedback Control
category: ie
---
<script>
function main(){
...
<div onload="main();">
	<canvas id="main-disp" width="700" height="300"></canvas>
	<p>Put mouse over to apply feedback control (try when the pole is upward!)</p>
	Control force:
	<div id='dispu'>U</div>
	<br>Cart position:
	<div id="dispx">AD</div>
	<br>Cart velocity:
	<div id="dispxd">XD</div>
	<br>Pole angle:
	<div id="dispa">A</div>
	<br>Pole angular velocity:
	<div id="dispad">X</div>
</div>
